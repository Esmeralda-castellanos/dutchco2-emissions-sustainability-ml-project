...
Time frame used in the source table: 1990–2024, although fleet emission factor values are only available for a later subset of years.
...
Open the notebook.
Load the raw CBS file from the data-raw/ folder.
Re-run the cleaning steps.
Recreate the modelling dataframe.
Reproduce the train-test split and baseline regression results.
...
GitHub repository:
Esmeralda-castellanos/dutchco2-emissions-sustainability-ml-project
